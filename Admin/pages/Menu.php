...
<body>
    <div class="img-fondo">
        ...
        <div class="velo-negro">
            ...
            <nav>
                <a href="index.html">Vender producto</a>
                <a href="nosotros.html">Mis ventas</a>
            </nav>
                ...
                <div class="productos">
                    ...
                    <?php } else { ?>
                        ...
                        foreach ($productos as $producto) {
                            ...
                            echo "<img src=" . $producto->getImg() . " alt=".$producto->getImg().">";
                           ...
                           echo "<p class='producto-precio'>"."₡".$producto->getPrecio()."</p>";
                            if ($_SESSION["rol"] == 1) {
                                echo "<p class='producto-precio'>Eliminar.</p>";
                            }
    ...
    <footer class="footer">
        ...
        <p>Copyright© 2022-Todos los derechos reservados Nuevas Ventas <span><a href="../controller/logout.php">Cerrar Sección</a></span></p>
    </footer>
